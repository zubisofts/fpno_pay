...
class AcceptanceFeePage extends StatefulWidget {
  const AcceptanceFeePage({Key? key}) : super(key: key);

  @override
  _AcceptanceFeePageState createState() => _AcceptanceFeePageState();
}

class _AcceptanceFeePageState extends State<AcceptanceFeePage> {
  late FPNUser _user;
  ...
  void initState() {
    ...
    context.read<DataBloc>().add(FetchPaymentsEvent(
        paymentType: PaymentType.AcceptanceFee, userId: AuthBloc.uid!));
    super.initState();
  }
